...
class BookEdit extends Component {
    ...
    getCreatedClub = () => {
        ...
        axios  
            .get(`${process.env.REACT_APP_API_URI}/book-clubs/created/one/${params.id}`, {withCredentials: true})
    ...
    handleFormSubmit = event => {
        ...
        const { params } = this.props.match;
        axios
            .patch(`${process.env.REACT_APP_API_URI}/book-clubs/${params.id}/edit`, {
                title,
                description,
                currentBookTitle,
                meetingDate,
            ...
            .then(() => {
                this.props.history.push(`/book-clubs/${params.id}/created`)
            })
