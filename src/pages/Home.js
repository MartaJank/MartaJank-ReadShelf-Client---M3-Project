...
function Home() {
  return (
    <div> 
      <img className="home-cover" src="https://res.cloudinary.com/martajank/image/upload/v1598566162/Sin_t%C3%ADtulo_eqzfzu.png" />
      <div className="horitzontal-scroll">
        <ul className="hs">
          <li className="item">
            ...
            <p className="card-text">You can search for as many books as you want and push them into different list!</p>
            <Link to={'/books'}><button className="card-btn">Book finder</button></Link>
          </li>
          <li className="item">
            ...
            <hr className="card-hr" />
            <p className="card-text">The different lists allow you to push books into them to sort your bookshelf!</p>
            <Link to={'/bookshelf'}><button className="card-btn">Build a Bookshelf</button></Link>
          </li>
          <li className="item">
            ...
            <hr className="card-hr" />
            <p className="card-text">You can also push books into tracking lists to know which books are pending, which are you reading and which you've read.</p>
            <Link to={'/tracking'}><button className="card-btn">Track your reads</button></Link>
          </li>
          <li className="item">
            ...
            <hr className="card-hr" />
            <p className="card-text">You can also create and join different book clubs to share your reading experience with others!</p>
            <Link to={'/book-clubs'}><button className="card-btn">Join</button></Link>
          </li>
        </ul>  
      </div>
      ...
      <div className="home-club-all">
        ...
        <div className="home-club">  
          <div className="home-club-left">
            ...
            <Link to={'/book-clubs'}><button className="card-btn">TRY IT HERE</button></Link>
          </div>
